...
#define nrn_init _nrn_init__ProbAMPANMDA3
#define _nrn_initial _nrn_initial__ProbAMPANMDA3
#define nrn_cur _nrn_cur__ProbAMPANMDA3
#define _nrn_current _nrn_current__ProbAMPANMDA3
#define nrn_jacob _nrn_jacob__ProbAMPANMDA3
#define nrn_state _nrn_state__ProbAMPANMDA3
#define _net_receive _net_receive__ProbAMPANMDA3 
#define setRNG setRNG__ProbAMPANMDA3 
#define state state__ProbAMPANMDA3 
...
#define erand erand_ProbAMPANMDA3
 extern double erand( );
 /* declare global and static user variables */
#define mggate mggate_ProbAMPANMDA3
 double mggate = 0;
#define mg mg_ProbAMPANMDA3
 double mg = 1;
 ...
 "mg_ProbAMPANMDA3", &mg_ProbAMPANMDA3,
 "mggate_ProbAMPANMDA3", &mggate_ProbAMPANMDA3,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 7;
 	...
 	ivoc_help("help ?1 ProbAMPANMDA3 ProbAMPANMDA_3.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 100 in file ProbAMPANMDA_3.mod:\n    \n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "ProbAMPANMDA_3.mod";
static const char* nmodl_file_text = 
