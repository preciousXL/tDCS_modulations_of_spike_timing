...
#define _f_trates _f_trates__sca 
#define rates rates__sca 
#define states states__sca 
#define trates trates__sca 
...
#define inactF _p[0]
#define inactF_columnindex 0
#define actF _p[1]
#define actF_columnindex 1
#define gbar _p[2]
#define gbar_columnindex 2
#define gca _p[3]
#define gca_columnindex 3
#define minf _p[4]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "ca_ion");
 	...
 	ivoc_help("help ?1 sca SlowCa.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("sca", "cannot be used with CVODE"); return 0;}
