...
#define subtree_traverse subtree_traverse_ 
...
extern "C" {
 ...
 static void _hoc_subtree_traverse(void);
...
extern Memb_func* memb_func;
 ...
 "setdata_childa", _hoc_setdata,
 "subtree_traverse", _hoc_subtree_traverse,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _childa_reg() {
  ...
  _initlists();
 	...
 	ivoc_help("help ?1 childa childa.mod\n");
 }
static int _reset;
