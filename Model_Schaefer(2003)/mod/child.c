...
#define subtree_traverse_all subtree_traverse_all_ 
...
extern "C" {
 ...
 static void _hoc_subtree_traverse_all(void);
...
extern Memb_func* memb_func;
 ...
 "setdata_child", _hoc_setdata,
 "subtree_traverse_all", _hoc_subtree_traverse_all,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _child_reg() {
  ...
  _initlists();
 	...
 	ivoc_help("help ?1 child child.mod\n");
 }
static int _reset;
...
static int subtree_traverse_all();
